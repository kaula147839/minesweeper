...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if game_over:
                if event.key == pygame.K_r:
                    ...
                    running = False
        elif not game_over and not victory and pygame.mouse.get_pressed(num_buttons=3)[0] == True:
        ...
        elif not game_over and not victory and  pygame.mouse.get_pressed(num_buttons=3)[2] == True:
            x_new,y_new = xy_change(mouse_x,mouse_y)
